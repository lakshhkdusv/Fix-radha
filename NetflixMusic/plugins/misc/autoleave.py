...
from NetflixMusic.core.call import Netflix, autoend, counter
from NetflixMusic.utils.database import get_client, set_loop, is_active_chat, is_autoend, is_autoleave
import logging
    ...
    while True:
        ...
        try:
            ...
            for chat_id in chatss:
                try:
                    users = len(await Netflix.call_listeners(chat_id))
